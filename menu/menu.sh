...
function check_and_update() {
    ...
    latest_commit=$(curl -s https://api.github.com/repos/darnix1/Premium/commits/main | grep -oP '"sha": "\K[^"]+')
    commit_messages=$(curl -s https://api.github.com/repos/darnix1/Premium/commits/main | grep -oP '"message": "\K[^"]+')
