...
<b>IP : ${ISP}</b>
<b>PAIS : $CITY</b>
<b>USUARIO : ${username[$i]} </b>
<b>TOTAL LOGIN IP : ${jumlah[$i]} </b>
<code>◇━━━━━━━━━━━━━━━━◇</code>
<b>TIEMPO LOGIN : IP LOGIN </b>
<code>$sship2</code>
<code>◇━━━━━━━━━━━━━━━━◇</code>
<i>${ssssh}x Multi Login Auto Bloqueo Activado ✅...</i>
"
...
<code>$sship2</code>
<code>◇━━━━━━━━━━━━━━━━◇</code>
<i>${ssssh}x Multi Login Bloqueo en $waktulockssh Minutos...</i>
"
sed -i "/${username[$i]}/d" /var/log/auth.log
curl -s --max-time $TIMES -d "chat_id=$CHATID&disable_web_page_preview=1&text=$TEXT2&parse_mode=html" $URL >/dev/null
cd
...
<code>$sship2</code>
<code>◇━━━━━━━━━━━━━━━━◇</code>
<i>${sship}x Multi Login ❌: ${ssssh}x Multi Login Advertencia ⚠️...</i>
"
sed -i "/${username[$i]}/d" /var/log/auth.log
